bad = ['whiskey', 'vodka', 'alcohol', 'beer', 'drunk', 'drugs', 'marijuana', 'cocaine', 'meth', 'heroin', 'crack', 'illegal', 'booger sugar',  'gun', 'pistol', 'shotgun', 'rifle', 'handgun', 'weapon', 'kill myself']
